package com.example.bluetooth.activity_right;
...
public class Right_MachineActivity extends AppCompatActivity implements View.OnTouchListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_right_machine);

        ImageView back = findViewById(R.id.back_right);
        ...
        left_position_fixed_ceng_edit_go.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    Toast.makeText(Right_MachineActivity.this, "请输入0-9的个位数", Toast.LENGTH_LONG).show();
                }
        ...
        left_Shipment_fixed_ceng_lie_edit_go.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    Toast.makeText(Right_MachineActivity.this, "对层数, 列数编辑框分别请输入0-9的个位数", Toast.LENGTH_LONG).show();
                }
